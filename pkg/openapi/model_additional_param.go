...
// checks if the AdditionalParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdditionalParam{}
...
func (o AdditionalParam) MarshalJSON() ([]byte, error) {
...
type NullableAdditionalParam struct {
	value *AdditionalParam
	isSet bool
}

func (v NullableAdditionalParam) Get() *AdditionalParam {
	return v.value
}

func (v *NullableAdditionalParam) Set(val *AdditionalParam) {
	v.value = val
	v.isSet = true
}

func (v NullableAdditionalParam) IsSet() bool {
	return v.isSet
}

func (v *NullableAdditionalParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdditionalParam(val *AdditionalParam) *NullableAdditionalParam {
	return &NullableAdditionalParam{value: val, isSet: true}
}

func (v NullableAdditionalParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdditionalParam) UnmarshalJSON(src []byte) error {
	v.isSet = true

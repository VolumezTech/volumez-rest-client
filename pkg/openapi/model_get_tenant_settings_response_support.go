...
type GetTenantSettingsResponseSupport struct {
	AllowCollectLogs *bool `json:"allowCollectLogs,omitempty"`
}
...
// GetAllowCollectLogs returns the AllowCollectLogs field value if set, zero value otherwise.
func (o *GetTenantSettingsResponseSupport) GetAllowCollectLogs() bool {
	if o == nil || IsNil(o.AllowCollectLogs) {
		var ret bool
		return ret
	}
	return *o.AllowCollectLogs
}
...
func (o *GetTenantSettingsResponseSupport) GetAllowCollectLogsOk() (*bool, bool) {
	...
	return o.AllowCollectLogs, true
}
...
// SetAllowCollectLogs gets a reference to the given bool and assigns it to the AllowCollectLogs field.
func (o *GetTenantSettingsResponseSupport) SetAllowCollectLogs(v bool) {
	o.AllowCollectLogs = &v
}
...
func (o GetTenantSettingsResponseSupport) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AllowCollectLogs) {
		toSerialize["allowCollectLogs"] = o.AllowCollectLogs
	}

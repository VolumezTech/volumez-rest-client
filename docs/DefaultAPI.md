...
[**ResetTenantSettings**](DefaultAPI.md#ResetTenantSettings) | **Post** /tenant-settings/reset | Reset tenant settings
...
> Job JobGet(ctx, job).Authorization(authorization).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DefaultAPI.JobGet(context.Background(), job).Authorization(authorization).Execute()
	if err != nil {
...
> RefreshTokenResponse TenantHostAccessCredentials(ctx).Refreshtoken(refreshtoken).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.DefaultAPI.TenantHostAccessCredentials(context.Background()).Refreshtoken(refreshtoken).Execute()
	if err != nil {

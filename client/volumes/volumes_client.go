...
type ClientService interface {
	BatchVolumesPlan(params *BatchVolumesPlanParams, opts ...ClientOption) (*BatchVolumesPlanOK, error)
...
func (a *Client) BatchVolumesPlan(params *BatchVolumesPlanParams, opts ...ClientOption) (*BatchVolumesPlanOK, error) {
	...
	if params == nil {
		params = NewBatchVolumesPlanParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "BatchVolumesPlan",
		Method:             "POST",
		PathPattern:        "/volumes/plan",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &BatchVolumesPlanReader{formats: a.formats},
	...
	success, ok := result.(*BatchVolumesPlanOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*BatchVolumesPlanDefault)

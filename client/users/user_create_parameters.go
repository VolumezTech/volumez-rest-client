...
type UserCreateParams struct {
	...
	/* Body.
	   ...
	   A user object
	*/
	Body *models.TenantCreateAdminUserRequest
...
func (o *UserCreateParams) WithBody(body *models.TenantCreateAdminUserRequest) *UserCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the user create params
func (o *UserCreateParams) SetBody(body *models.TenantCreateAdminUserRequest) {
	o.Body = body
}

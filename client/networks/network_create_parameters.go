...
// WithAuthorization adds the authorization to the network create params
func (o *NetworkCreateParams) WithAuthorization(authorization *string) *NetworkCreateParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the network create params
func (o *NetworkCreateParams) SetAuthorization(authorization *string) {
	o.Authorization = authorization
}

// WithBody adds the body to the network create params
func (o *NetworkCreateParams) WithBody(body *models.Network) *NetworkCreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the network create params
func (o *NetworkCreateParams) SetBody(body *models.Network) {
	o.Body = body
}

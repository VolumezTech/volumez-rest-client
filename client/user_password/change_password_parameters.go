...
func (o *ChangePasswordParams) WithBody(body *models.ChangePasswordRequest) *ChangePasswordParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the change password params
func (o *ChangePasswordParams) SetBody(body *models.ChangePasswordRequest) {
	o.Body = body
}

...
// WithAuthorization adds the authorization to the policies list params
func (o *PoliciesListParams) WithAuthorization(authorization *string) *PoliciesListParams {
	o.SetAuthorization(authorization)
	return o
}

// SetAuthorization adds the authorization to the policies list params
func (o *PoliciesListParams) SetAuthorization(authorization *string) {

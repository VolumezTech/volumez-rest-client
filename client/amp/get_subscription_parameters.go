...
// WithToken adds the token to the get subscription params
func (o *GetSubscriptionParams) WithToken(token string) *GetSubscriptionParams {
	o.SetToken(token)
	return o
}

// SetToken adds the token to the get subscription params
func (o *GetSubscriptionParams) SetToken(token string) {
	o.Token = token
}
